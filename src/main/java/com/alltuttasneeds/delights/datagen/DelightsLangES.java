...
public class DelightsLangES extends LanguageProvider {
    private static final Map<String, String> TRANSLATIONS = Map.ofEntries(
            ...
            entry("item.tuttasdelights.pasta_with_pod", "Pasta con vaina"),
            ...
            entry("item.tuttasdelights.pod_slice", "Rodaja de vaina"),
            entry("item.tuttasdelights.pod_with_honey_on_a_stick", "Vaina con miel en un palo"),

...
public class TDTags {
    ...
    public static final TagKey<Block> WOODEN_CLASSIC_DOORS = modBlockTag("wooden_doors/door");
    ...
    public static final TagKey<Item> WOODEN_CLASSIC_DOORS_ITEMS = modItemTag("wooden_doors/door");
    ...
    public static final TagKey<Item> CLASSIC_DOORS_ITEMS = modItemTag("doors/door");
